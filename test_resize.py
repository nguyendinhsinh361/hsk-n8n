...
def download_from_drive(drive_links, output_path):
    """
    ...
    token_path = 'tools/app/auth/token_downloads_images.json'
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file(
                'tools/app/auth/credentials.json', SCOPES)
    ...
    for i, link in enumerate(links):
        try:
            ...
            file_id = extract_file_id_from_drive_link(link)
...
def convert_to_webp(input_path, output_path=None, target_kb=50, quality_start=80, min_quality=10, min_scale=0.3):
    """
...
def batch_convert_from_drive_links(drive_links_string, download_dir="downloaded_images", output_dir="webp_images", target_kb=50):
    """
    ...
    downloaded_files = download_from_drive(drive_links_string, download_dir)
    ...
    for i, input_file in enumerate(downloaded_files):
        try:
            ...
            _, output_file = convert_to_webp(input_file, output_path, target_kb)
...
if __name__ == "__main__":
    # Chuỗi chứa các link Google Drive
    drive_links = """https://drive.google.com/file/d/1nBO_0tLpgH6K-5SZpkPy9-XklYWBV_Rp/view?usp=drive_link 
https://drive.google.com/file/d/1JdTPh_CwSan8AScsuGTkADnd07OzDEw0/view?usp=drive_link
https://drive.google.com/file/d/1tHCoLo79LJXbA0LdiCpN6xgw8pT2EdOh/view?usp=drive_link 
https://drive.google.com/file/d/1DxIwXMduStD2DS0hxOn3aC-WwCsoWnee/view?usp=drive_link 
https://drive.google.com/file/d/1hanF4Z6cwUvyJuTYdeNNAa-Io0P4Zbvi/view?usp=drive_link"""
    
    # Thực hiện tải và chuyển đổi
    webp_files = batch_convert_from_drive_links(
        drive_links,
